...
-- [[ X PRO V3.2.0 - COMPETITIVE & TOURNAMENT SUITE ]]
...
local function BuildUI()
    ...
    Title.Text = "⚡ X PRO <font color='#00dcff'>V3.2.0</font>"; Title.RichText = true
...
local function Init()
    ...
    Notify("X PRO V3.2.0", "Tournament Pro Active! [Insert] Menu [F] Lock Target [End] Unload")
end
