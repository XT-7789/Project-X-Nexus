...
-- [[ X PRO V3.2.1 - COMPETITIVE & TOURNAMENT SUITE ]]
...
local function BuildUI()
    ...
    Title.Text = "⚡ X PRO <font color='#00dcff'>V3.2.1</font>"; Title.RichText = true
...
local function Init()
    ...
    Notify("X PRO V3.2.1", "Tournament Pro Active! [Insert] Menu [F] Lock Target [End] Unload")
end
